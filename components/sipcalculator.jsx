        ...
        <div className="sip-calculator container mx-auto p-3 sticky top-0 z-10">
            ...
            <div className="flex justify-center space-x-4 mb-8">
                <Button
                    ...
                    className={` rounded-full hover:bg-[var(--rv-primary)] hover:text-[var(--rv-white)] ${isMonthlySip ? 'bg-[var(--rv-primary)] text-[var(--rv-white)]' : 'bg-[var(--rv-white)] text-[var(--rv-black)]  border'}`}
                >
                    Monthly SIP
                </Button>
                <Button
