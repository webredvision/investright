        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pl-3">
          {blogs.slice(0, 3).map((blog, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-gradient-to-br from-[var(--rv-gredient)] to-[var(--rv-gredient1)] shadow-lg rounded-lg overflow-hidden relative"
              >
                {/* Date Badge */}
                ...
                <div className="p-5 relative">
                  ...
                  <Link
                    ...
                    className="text-[var(--rv-primary)] font-semibold hover:underline"
                  >
                    Read More
                  </Link>
                </div>
