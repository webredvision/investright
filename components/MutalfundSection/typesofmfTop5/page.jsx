  ...
  return (
    <div>
      <section className="text-[var(--rv-white)] overflow-hidden">
        <div className="w-full bg-gradient-to-br from-[var(--rv-gredient)] to-[var(--rv-gredient1)] rounded-2xl p-4 lg:p-8">
            ...
            {categories.map((cat, index) => (
              <button
                ...
                className={`px-4 py-2 rounded-t font-medium ${activeTab === cat
                  ...
                  : "bg-[var(--rv-white)] text-[var(--rv-black)] hover:bg-[var(--rv-primary)] hover:text-[var(--rv-text)]"
                  }`}
              >
                {cat}
              </button>
