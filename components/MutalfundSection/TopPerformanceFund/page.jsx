...
export default function TopTaxSavingFunds() {
  ...
  return (
    <div className="bg-[var(--rv-secondary)] shadow-lg rounded-xl overflow-hidden mt-10 px-2 sm:px-4 md:px-6">
          ...
          {categories.map((cat, index) => (
            <button
              ...
              className={`text-lg sm:text-xl md:text-2xl px-6 sm:px-10 py-3 sm:py-5 ${
                activeTab === cat
                  ? "bg-[var(--rv-ternary)] text-[var(--rv-primary)] border-b-2 border-[var(--rv-secondary)]"
                  : "text-[var(--rv-white)]"
              }`}
            >
              {cat}
      ...
      <div className="text-center p-4">
        <Link className="" href={"/performance/fund-performance"}>
          <button className="text-[var(--rv-primary)] text-base md:text-xl hover:underline">
