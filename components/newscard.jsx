    ...
    return (
        <div className="p-1 ">
            <Link href={item?.link} target="_blank">
                <div className="max-w-sm   rounded-lg shadow hover:shadow-xl hover:scale-105 transition-transform bg-gradient-to-br from-[var(--rv-gredient)] to-[var(--rv-gredient1)] relative min-h-[400px] "> {/* Add 'relative' class */}
