...
<h2
      ...
      >
        Latest{" "}
        <span className="text-[var(--rv-primary)]">News</span>
      </h2>
            <section className="">
                ...
                <div className="gap-4 flex flex-col md:flex-row ">
                    ...
                    <div className="mb-6">
                        ...
                        <div className="grid md:grid-cols-3 grid-cols-1 mb-6">
                            <div
                                className={`px-5 py-3 rounded-s-lg cursor-pointer ${activeCategory === "ipo" ? "bg-[var(--rv-primary)]" : "bg-gradient-to-br from-[var(--rv-gredient)] to-[var(--rv-gredient1)]"} text-[var(--rv-white)] text-center`}
                                onClick={() => setActiveCategory("ipo")}
                            >
                                IPO
                            </div>
                            <div
                                className={`px-5 py-3 cursor-pointer ${activeCategory === "market" ? "bg-[var(--rv-primary)]" : "bg-gradient-to-br from-[var(--rv-gredient)] to-[var(--rv-gredient1)]"} text-[var(--rv-white)] text-center`}
                                onClick={() => setActiveCategory("market")}
                            >
                                Market
                            </div>
                            <div
                                className={`px-5 py-3 rounded-e-lg cursor-pointer ${activeCategory === "upcoming" ? "bg-[var(--rv-primary)]" : "bg-gradient-to-br from-[var(--rv-gredient)] to-[var(--rv-gredient1)]"} text-[var(--rv-white)] text-center`}
