...
export function BseReturnChart({ data }) {
  ...
  return (
    <Card className="bg-gradient-to-br from-[var(--rv-gredient)] to-[var(--rv-gredient1)] border-0 rounded-xl">
      <CardHeader>
          ...
          >
            ...
            <defs>
              <linearGradient id="fillGradient" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stopColor="var(--rv-secondary)" stopOpacity={1} />
                <stop offset="100%" stopColor="var(--rv-secondary)" stopOpacity={0.5} />
              </linearGradient>
            </defs>
            <Area
              dataKey={data && data.length > 0 ? "sensex_close" : "mobile"}
