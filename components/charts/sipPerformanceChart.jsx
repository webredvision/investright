...
export function SipPerformanceChart({ piedata, startDate, endDate, title }) {
    ...
    return (
        <Card className="dark:text-[var(--rv-primary)]">
            <CardHeader>
    ...
    <div className="flex items-center gap-2">
      <span className="h-3 w-3 rounded-full" style={{ backgroundColor: "var(--rv-white)" }}></span>
      <span className="text-sm dark:text-[var(--rv-white)]">Amount Invested</span>
    </div>
    <div className="flex items-center gap-2">
      <span className="h-3 w-3 rounded-full" style={{ backgroundColor: "var(--rv-primary)" }}></span>
      <span className="text-sm dark:text-[var(--rv-primary)]">Current Value</span>
    </div>
  </div>
            </CardHeader>
            <CardContent>
