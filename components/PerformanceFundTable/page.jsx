...
useEffect(() => {
  ...
  return (
    <div className="container mx-auto main_section">
      ...
      {/* Fund List */}
      <div className="bg-gradient-to-br from-[var(--rv-gredient)] to-[var(--rv-gredient1)] text-[var(--rv-white)] shadow rounded  overflow-hidden">
        {filteredFunds.length > 0 ? (
          filteredFunds.map((fund, idx) => (
            <div
              key={idx}
               onClick={() => handleSelectFunds(fund)}
              className="flex flex-col md:flex-row justify-between items-center border-b border-[var(--rv-ternary)] gap-4 p-4 hover:bg-[var(--rv-primary)] cursor-pointer"
            >
