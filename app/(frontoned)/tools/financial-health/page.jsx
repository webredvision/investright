      ...
      <div>
        ...
        <div className="flex flex-col bg-cover bg-center relative">
          ...
          <div className="flex flex-col items-center justify-center flex-grow text-center px-6 relative py-20 space-y-5">
            <div className="bg-[var(--rv-secondary)] backdrop-blur-xl px-10 py-7 rounded-2xl shadow-xl border border-white/20 max-w-5xl">
              {!isStart ? (
            ...
            {isQuizCompleted && (
              <div
                id="showfunds"
                className=" backdrop-blur-xl px-10 py-7 rounded-2xl  w-5xl"
              >
                <div className="text-left mt-6">
                  <div className="text-center mb-5">
                    <h3 className="text-2xl font-bold text-[var(--rv-primary)] mb-4">
